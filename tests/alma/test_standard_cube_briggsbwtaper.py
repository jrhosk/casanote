...
#__basename  = os.path.abspath(__file__)
__stakeholder_path = os.path.realpath(__file__).split("tests/alma/" + __basename)[0]
sys.path.append(__stakeholder_path)
print('\n========================================\n')

print('Stakeholder path: ' + __stakeholder_path)
print('System path: ' + str(sys.path[-1]))
print('System path: ' + str(__name__))
...
from tests.baseclass.stakeholder_base_class import test_stakeholder_base
